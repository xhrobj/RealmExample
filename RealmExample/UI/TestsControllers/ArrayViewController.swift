...
struct ArrayViewState: Codable {
    let numberOfItems: Int
    let creationTime: TimeInterval
    let insertAt0Time: TimeInterval
    let insertAtMidTime: TimeInterval
    let insertAtEndTime: TimeInterval
    let removeAt0Time: TimeInterval
    let removeAtMidTime: TimeInterval
    let removeAtEndTime: TimeInterval
    let lookupByIndexTime: TimeInterval
    let lookupByObjectTime: TimeInterval
}
...
class ArrayViewController: DataStructuresViewController {
    ...
    private let fileCache = FileCache<ArrayViewState>(name: .arrayTest)
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        let cache = ArrayViewState(
            numberOfItems: numberOfItems,
            creationTime: creationTime,
            insertAt0Time: insertAt0Time,
            insertAtMidTime: insertAtMidTime,
            insertAtEndTime: insertAtEndTime,
            removeAt0Time: removeAt0Time,
            removeAtMidTime: removeAtMidTime,
            removeAtEndTime: removeAtEndTime,
            lookupByIndexTime: lookupByIndexTime,
            lookupByObjectTime: lookupByObjectTime
        )
    ...
    private func initWithCache() {
        ...
        insertAt0Time = state.insertAt0Time
        insertAtMidTime = state.insertAtMidTime
        insertAtEndTime = state.insertAtEndTime
        removeAt0Time = state.removeAt0Time
        removeAtMidTime = state.removeAtMidTime
        removeAtEndTime = state.removeAtEndTime
        lookupByIndexTime = state.lookupByIndexTime
        lookupByObjectTime = state.lookupByObjectTime
        updateCountLabel()
